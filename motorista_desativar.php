...
<html lang="pt-BR">
    <head>
        ...
        <title>Desativar motorista</title>
        <style>
            .body{
                text-align: right;
            }
        ...
        <div class="container">
            ...
            <form method="POST" action="motorista_query.php">
                <div class="form-group row">
                    <h3>Confirma desativaçao do motorista?</h3>
                    <div class="col-8">
                        <input type="hidden" value="<?php echo $id_motorista ?>" name="id_motorista" id="id_motorista">
                    </div>
                </div>
                <div class="form-group row">
                        <button type="submit" class="btn btn-danger" id="desativar" name="desativar">Desativar</button>
                    <div class="col-8">
