...
<html lang="pt-BR">
    <head>
        ...
        <script type="text/javascript">
            function confirmaCadastro()
            {
                ...
                nModelo_Carro = document.getElementById("modelo_carro").value;
                nSexo = document.getElementById("sexo").value;
                if (nNome == "" || nCpf == "" || nDt_Nascimento == "" || nModelo_Carro == "" || nSexo == "")
                {
                    ...
                    if (decisao == true) {
                        document.add.action = "motorista_query.php";
    ...
    <body>
        <h1 align="center">Adicionar novo Motorista</h1>
        <div class="container">

            <form name="add" id="add" method="POST" action="motorista_query.php">
                ...
                <div class="form-group row">
                    <label for="modelo_carro" class="col-2 col-form-label" id="lblie">Modelo do Carro</label>
                    <div class="col-8">
                        <input type="text" class="form-control" id="modelo_carro" name="modelo_carro" required>
                    </div>
                </div>
                <div class="form-group row">
