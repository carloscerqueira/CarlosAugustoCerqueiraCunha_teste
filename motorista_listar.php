            ...
            <table class="table table-striped table-condensed" >
                ...
                if (mysqli_num_rows($sql) > 0) {
                    while ($registro = mysqli_fetch_array($sql)) {
                        ...
                        echo "<td> $sexo  </td>";
                        if ($registro['stats'] == true) {
                            echo "<td><a href='motorista_desativar.php?id_motorista=" . $id_motorista . "'>
                                <input type='button' class='btn btn-danger' value='Desativar'></a></td>";
                            }
                        else {
                            echo "<td><a href='motorista_ativar.php?id_motorista=" . $id_motorista . "'>
                                <input type='button' class='btn btn-success' value='Ativar'></a></td>";
                                                }
                        echo "</tr>";
                    }
                }
